...
describe("get_image_url", function()
  it("link1", function()
    ...
    vim.fn.search('^[](link)$')
    assert.equal('', imgup.get_image_url())
  end)
  ...
  describe("img1", function()
    ...
    it("match on head", function()
      assert.equal('image', imgup.get_image_url())
    end)
    ...
    vim.cmd[[normal! f)]]
    assert.equal('', imgup.get_image_url(), 'not match on end paren')
  end)
  ...
  describe("img2", function()
    ...
    it("match on head", function()
      assert.equal('image_with_width', imgup.get_image_url())
    end)
  ...
  it("img3", function()
    ...
    it("match on tail", function()
      assert.equal('image_with_size', imgup.get_image_url())
    end)
    vim.cmd[[normal! t)]]
    it("match on tail", function()
      assert.equal('image_with_size', imgup.get_image_url())
  ...
  it("img_inthelink1", function()
    ...
    assert.equal('', imgup.get_image_url(), 'not match on link head')
    vim.cmd[[normal! f!]]
    it("match on head", function()
      assert.equal('image', imgup.get_image_url())
    end)
  ...
  it("img_twice", function()
    ...
    vim.cmd[[normal! f)]]
    assert.equal('', imgup.get_image_url(), 'not match on left-end-paren')
    vim.cmd[[normal! l]]
    assert.equal('', imgup.get_image_url(), 'not match on interlude')
    vim.cmd[[normal! f!]]
    it("match on right-head", function()
      assert.equal('image2', imgup.get_image_url())
    end)
    vim.cmd[[normal! t)]]
    ...
    vim.cmd[[normal! f)]]
    assert.equal('', imgup.get_image_url(), 'not match on right-end-paren')
  end)
end)
